...
**Learning:** In pandas,  raises a `TypeError` when called on an `object` dtype column containing `datetime.date` objects returned by SQLAlchemy.
...
## 2026-09-18 - DataFrame Argument TypeError with Dates
