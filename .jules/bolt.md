...
## 2025-05-15 - Optimization of Feature Window Functions and Prediction Caching
...
## 2025-05-15 - Caching vs Overrides
**Learning:** When building intelligent DB caching logic inside service layers (like caching backend model predictions), always explicitly check and bypass the cache when user-supplied 'overrides' (scenario tweaks) are present. Failing to do so breaks functionality by serving generic cached baselines instead of computed overrides.
