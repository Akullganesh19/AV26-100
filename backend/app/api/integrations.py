...
class IntegrationService:
    ...
    async def sync_district_to_algolia(self, district_data: dict):
        ...
        # Offload sync I/O to a separate thread, wrapped with self-healing retry
    ...
    async def upload_report_to_cloudinary(self, file_bytes: bytes, district_id: str):
        ...
        # Cloudinary upload is blocking, so we need to run it in a thread and wrap with retry
        def _upload():
