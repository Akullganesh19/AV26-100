...
class IntegrationService:
    ...
    async def upload_report_to_cloudinary(self, file_bytes: bytes, district_id: str):
        ...
        upload_result = await with_retry(asyncio.to_thread, cloudinary.uploader.upload, file_bytes, resource_type="raw", public_id=f"reports/district_{district_id}", format="pdf", max_attempts=3)
