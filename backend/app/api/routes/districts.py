...
async def list_districts(
    ...
    try:
        ...
        import logging
        logging.getLogger(__name__).error("Failed to retrieve jurisdiction matrix: %s", str(e), exc_info=True)
...
async def get_district_detail(
    ...
    try:
        ...
        import logging
        logging.getLogger(__name__).error("Failed to fetch district detail: %s", str(e), exc_info=True)
        raise HTTPException(status_code=500, detail="Internal Server Error")
