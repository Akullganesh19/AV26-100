...
async def diagnose_heart(
    ...
    try:
        ...
        import logging
        logging.getLogger(__name__).error("Heart diagnosis failed", extra={"error_type": type(e).__name__}, exc_info=True)
        ...
        raise HTTPException(status_code=500, detail="Heart diagnosis failed")
...
async def diagnose_diabetes(
    ...
    try:
        ...
        # Sentinel: Avoid leaking system internals in error messages
        import logging
        logging.getLogger(__name__).error("Diabetes diagnosis failed", extra={"error_type": type(e).__name__}, exc_info=True)
        ...
        raise HTTPException(status_code=500, detail="Diabetes diagnosis failed")
...
async def diagnose_parkinsons(
    ...
    try:
        ...
        # Sentinel: Avoid leaking system internals in error messages
        import logging
        logging.getLogger(__name__).error("Parkinson's diagnosis failed", extra={"error_type": type(e).__name__}, exc_info=True)
        ...
        raise HTTPException(status_code=500, detail="Parkinson's diagnosis failed")
...
async def generate_screening_report(
    ...
    try:
        ...
        # Sentinel: Avoid leaking system internals in error messages
        import logging
        logging.getLogger(__name__).error("PDF generation failed", extra={"error_type": type(e).__name__}, exc_info=True)
