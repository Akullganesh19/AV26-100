...
async def diagnose_heart(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Internal server error during heart diagnosis.")
...
async def diagnose_diabetes(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Internal server error during diabetes diagnosis.")
...
async def diagnose_parkinsons(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Internal server error during parkinsons diagnosis.")
