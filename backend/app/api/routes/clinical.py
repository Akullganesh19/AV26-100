...
async def diagnose_heart(
    ...
    try:
        ...
        import logging
        logging.getLogger(__name__).error(f"Clinical heart screening error: {str(e)}", exc_info=True)
...
async def diagnose_diabetes(
    ...
    try:
        ...
        import logging
        logging.getLogger(__name__).error(f"Clinical diabetes screening error: {str(e)}", exc_info=True)
...
async def diagnose_parkinsons(
    ...
    try:
        ...
        import logging
        logging.getLogger(__name__).error(f"Clinical parkinsons screening error: {str(e)}", exc_info=True)
...
async def generate_screening_report(
    ...
    try:
        ...
        import logging
        logging.getLogger(__name__).error(f"PDF generation failed: {str(e)}", exc_info=True)
