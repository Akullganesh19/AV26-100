...
async def diagnose_heart(
    ...
    try:
        ...
        logger.exception("Failed to diagnose heart")
...
async def diagnose_diabetes(
    ...
    try:
        ...
        logger.exception("Failed to diagnose diabetes")
...
async def diagnose_parkinsons(
    ...
    try:
        ...
        logger.exception("Failed to diagnose parkinsons")
        ...
        raise HTTPException(status_code=500, detail="Internal server error during Parkinson's screening.")
