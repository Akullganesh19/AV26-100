...
class IntegrationService:
    def __init__(self):
        # Algolia Setup
        self.search_client = SearchClient.create(getattr(settings, 'ALGOLIA_APP_ID', 'test_app_id'), settings.ALGOLIA_API_KEY)
        ...
        # GetStream Setup
        self.stream = StreamChat(api_key=getattr(settings, 'STREAM_API_KEY', 'test'), api_secret=getattr(settings, 'STREAM_API_SECRET', 'test'))
