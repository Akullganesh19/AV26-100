...
async def test_get_current_user_redis_failure_fails_closed():
    ...
    """
    token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyLCJqdGkiOiJtaXNzaW9uLWNyaXRpY2FsLWp0aSJ9.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c"
    ...
    with patch("redis.asyncio.from_url") as mock_from_url:
        ...
        with pytest.raises(HTTPException) as exc_info:
            await get_current_user(db=AsyncMock(), token=token, public_key="dummy")
