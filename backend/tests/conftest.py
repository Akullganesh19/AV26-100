...
# In CI environment where DATABASE_URL already has _test, we might get _test_test
if TEST_DATABASE_URL.endswith("_test_test"):
    TEST_DATABASE_URL = TEST_DATABASE_URL[:-5]
