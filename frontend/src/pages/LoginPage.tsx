      ...
      <div className="w-full max-w-md z-10">
        ...
        <div className="glass-panel p-8 rounded-3xl">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            {/* Palette: Added HTML for/id linking to ensure screen readers associate labels with inputs */}
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                />
                {/* Palette: Added aria-label to toggle button for screen reader support */}
                <button
                  type="button"
                  aria-label={showPassword ? "Hide password" : "Show password"}
                  onClick={() => setShowPassword(!showPassword)}
                  className="absolute right-4 top-1/2 -translate-y-1/2 text-slate-500 hover:text-white transition-colors focus-visible:ring-2 focus-visible:ring-brand-primary focus:outline-none"
                >
