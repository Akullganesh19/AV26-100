        ...
        <div className="glass-panel p-8 rounded-3xl">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            <div className="space-y-2">
              {/* Palette: Added htmlFor/id to properly associate labels with inputs */}
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                />
                {/* Palette: Added aria-label to icon-only button and aria-hidden to decorative icons */}
                <button
                  type="button"
            ...
            {/* Palette: Added aria-busy to submit button to convey loading state */}
            <button
              disabled={isLoading}
              aria-busy={isLoading}
              type="submit"
