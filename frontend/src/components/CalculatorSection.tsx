  ...
  return (
    <div className="relative w-full h-6 flex items-center group">
      <input
        ...
        aria-label="Pages"
        className="w-full h-1.5 bg-[#1E1E1E] rounded-lg appearance-none cursor-pointer accent-[#FF5656] focus-visible:ring-2 focus-visible:ring-white focus-visible:outline-none"
      />
    </div>
  );
};
              ...
              <div className="flex flex-wrap gap-4" role="radiogroup" aria-labelledby="service-type-label">
                {[
                  ...
                  <button
                    ...
                    className="flex items-center gap-3 group cursor-pointer focus-visible:ring-2 focus-visible:ring-white focus-visible:outline-none rounded"
                  >
                ...
                {[
                  ...
                  <label key={addon.id} className="flex items-center justify-between group cursor-pointer">
                    <div className="flex items-center gap-3">
                      ...
                      />
                      <div className={`w-5 h-5 border-2 rounded flex items-center justify-center transition-all peer-focus-visible:ring-2 peer-focus-visible:ring-white peer-focus-visible:outline-none ${addon.state ? 'bg-[#FF5656] border-[#FF5656]' : 'border-[#333]'}`}>
              ...
              <div className="grid gap-4" role="radiogroup" aria-labelledby="timeline-label">
                {[
                  ...
                  <button
                    ...
                    className="flex items-center justify-between group cursor-pointer w-full text-left focus-visible:ring-2 focus-visible:ring-white focus-visible:outline-none rounded"
                  >
                    <div className="flex items-center gap-3">
