          ...
          <div className="bg-[#0D0D0D] p-8 lg:p-12 flex flex-col gap-10 divide-y divide-[#1E1E1E]">
              ...
              <div className="flex flex-wrap gap-4" role="radiogroup" aria-labelledby="service-type-label">
                {[
                  ...
                  <button
                    ...
                    className="flex items-center gap-3 group cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FF5656] rounded-md p-1"
                  >
            ...
            <div className="pt-10 space-y-6">
              <div className="flex justify-between items-end">
                <h3 id="pages-label" className="text-lg font-medium opacity-80">Number of Pages</h3>
                <span className="text-2xl font-bold text-[#FF5656]">{pages}</span>
              </div>
              <div className="space-y-2">
                <Slider value={pages} min={1} max={30} step={1} onChange={setPages} aria-labelledby="pages-label" />
            ...
            <div className="pt-10 space-y-6">
              ...
              <div className="grid gap-4">
                {[
                  ...
                  <label key={addon.id} className="flex items-center justify-between group cursor-pointer focus-within:ring-2 focus-within:ring-[#FF5656] focus-within:outline-none rounded-md p-1">
              ...
              <div className="grid gap-4" role="radiogroup" aria-labelledby="timeline-label">
                {[
                  ...
                  <button
                    ...
                    className="flex items-center justify-between group cursor-pointer w-full text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FF5656] rounded-md p-1"
                  >
                    <div className="flex items-center gap-3">
