        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 rounded-2xl overflow-hidden border border-[#1E1E1E]">
          ...
          <div className="bg-[#0D0D0D] p-8 lg:p-12 flex flex-col gap-10 divide-y divide-[#1E1E1E]">
            ...
            <div className="space-y-6">
              ...
              {/* Palette: Added role="radiogroup" and role="radio" to custom button controls for screen reader accessibility */}
              <div className="flex flex-wrap gap-4" role="radiogroup" aria-label="Service Type">
                {[
                  ...
                  <button
                    ...
                    className="flex items-center gap-3 group cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FF5656] rounded-md"
                  >
                ...
                {[
                  ...
                  <label key={addon.id} className="flex items-center justify-between group cursor-pointer relative">
                    <div className="flex items-center gap-3">
                      {/* Palette: Changed display:none to sr-only and used peer to preserve keyboard focusability for the custom checkbox */}
                      <input 
                        type="checkbox" 
              ...
              <div className="grid gap-4" role="radiogroup" aria-label="Timeline">
                {[
                  ...
                  <button
                    ...
                    className="flex items-center justify-between group cursor-pointer w-full text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FF5656] rounded-md"
                  >
                    <div className="flex items-center gap-3">
