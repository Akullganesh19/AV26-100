              ...
              <div className="flex flex-wrap gap-4" role="radiogroup" aria-label="Service Type">
                {[
                  ...
                  <button
                    ...
                    className="flex items-center gap-3 group cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FF5656] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0D0D0D] rounded-sm"
                  >
              ...
              <div className="grid gap-4" role="radiogroup" aria-label="Timeline">
                {[
                  ...
                  <button
                    ...
                    className="flex items-center justify-between group cursor-pointer w-full text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FF5656] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0D0D0D] rounded-sm"
                  >
                    <div className="flex items-center gap-3">
