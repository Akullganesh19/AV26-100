...
const Slider = ({ value, min, max, step, onChange }: any) => {
  return (
    <div className="relative w-full h-6 flex items-center group">
      {/* 🎨 UX Concern: Custom slider lacked aria-label, causing screen readers to announce an unlabeled slider. Also added focus styles. */}
      <input
        type="range"
        min={min}
        max={max}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 rounded-2xl overflow-hidden border border-[#1E1E1E]">
          ...
          <div className="bg-[#0D0D0D] p-8 lg:p-12 flex flex-col gap-10 divide-y divide-[#1E1E1E]">
            ...
            <div className="space-y-6">
              ...
              {/* 🎨 UX Concern: Custom radio buttons lacked semantic role="radiogroup" and aria-checked states. Keyboard focus was also missing. */}
              <div className="flex flex-wrap gap-4" role="radiogroup" aria-labelledby="service-type-label">
                {[
                  ...
                  <button
                    ...
                    className="flex items-center gap-3 group cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FF5656] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0D0D0D] rounded-md p-1 -m-1"
                  >
            ...
            <div className="pt-10 space-y-6">
              ...
              <div className="grid gap-4">
                {/* 🎨 UX Concern: Checkboxes used display:none (hidden) rendering them completely inaccessible to keyboard users and screen readers. Changed to visually hidden (sr-only) and added focus rings. */}
                {[
            ...
            <div className="pt-10 space-y-6">
              ...
              {/* 🎨 UX Concern: Timeline options acted like radio buttons but lacked semantic roles, checked states, and keyboard focus states. */}
              <div className="grid gap-4" role="radiogroup" aria-labelledby="timeline-label">
                {[
                  ...
                  <button
                    ...
                    className="flex items-center justify-between group cursor-pointer w-full text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FF5656] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0D0D0D] rounded-md p-1 -m-1"
                  >
                    <div className="flex items-center gap-3">
