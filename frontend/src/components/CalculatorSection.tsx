              ...
              <div className="flex flex-wrap gap-4" role="radiogroup" aria-labelledby="service-type-label">
                {[
                  ...
                  <button
                    ...
                    className="flex items-center gap-3 group cursor-pointer focus-visible:ring-2 focus-visible:ring-[#FF5656] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0D0D0D] rounded outline-none"
                  >
              ...
              <div className="grid gap-4" role="radiogroup" aria-labelledby="timeline-label">
                {[
                  ...
                  <button
                    ...
                    className="flex items-center justify-between group cursor-pointer w-full text-left focus-visible:ring-2 focus-visible:ring-[#FF5656] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0D0D0D] rounded outline-none"
                  >
                    <div className="flex items-center gap-3">
