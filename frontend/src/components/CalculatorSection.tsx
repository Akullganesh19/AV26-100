        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 rounded-2xl overflow-hidden border border-[#1E1E1E]">
          ...
          <div className="bg-[#0D0D0D] p-8 lg:p-12 flex flex-col gap-10 divide-y divide-[#1E1E1E]">
            ...
            <div className="space-y-6">
              ...
              <div role="radiogroup" aria-label="Service Type" className="flex flex-wrap gap-4">
                {[
                  ...
                  <button
                    ...
                    className="flex items-center gap-3 group cursor-pointer focus-visible:ring-2 focus-visible:ring-[#FF5656] focus:outline-none rounded"
                  >
            ...
            <div className="pt-10 space-y-6">
              ...
              <div role="radiogroup" aria-label="Timeline" className="grid gap-4">
                {[
                  ...
                  <button
                    ...
                    className="flex items-center justify-between group cursor-pointer w-full text-left focus-visible:ring-2 focus-visible:ring-[#FF5656] focus:outline-none rounded"
                  >
                    <div className="flex items-center gap-3">
